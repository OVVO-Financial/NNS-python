...
META: dict[str, ApiMeta] = {
    ...
    "co_lpm_nd": ApiMeta("Co-moments", "Co.LPM_nD", "implemented", "N-dimensional co-lower partial moment wrapper."),
    "co_upm_nd": ApiMeta("Co-moments", "Co.UPM_nD", "implemented", "N-dimensional co-upper partial moment wrapper."),
    "dpm_nd": ApiMeta("Co-moments", "DPM_nD", "implemented", "N-dimensional directional partial moment wrapper."),
    ...
    "fsd": ApiMeta("Stochastic dominance, superiority, and simulation", "NNS.FSD", "implemented", "First-order stochastic dominance."),
    "ssd": ApiMeta("Stochastic dominance, superiority, and simulation", "NNS.SSD", "implemented", "Second-order stochastic dominance."),
    "tsd": ApiMeta("Stochastic dominance, superiority, and simulation", "NNS.TSD", "implemented", "Third-order stochastic dominance."),
    "fsd_uni": ApiMeta("Stochastic dominance, superiority, and simulation", "NNS.FSD.uni", "implemented", "Univariate FSD wrapper."),
    "ssd_uni": ApiMeta("Stochastic dominance, superiority, and simulation", "NNS.SSD.uni", "implemented", "Univariate SSD wrapper."),
    "tsd_uni": ApiMeta("Stochastic dominance, superiority, and simulation", "NNS.TSD.uni", "implemented", "Univariate TSD wrapper."),
    ...
    "dy_d": ApiMeta("Differentiation", "dy.d_", "partial", "Multivariate derivative helper."),
